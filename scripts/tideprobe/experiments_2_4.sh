...
LAYER_OUT_DIR="${LAYER_OUT_DIR:-/home/ma-user/work/bucket-wulan-green/chenyanbo/decodeatt/runs/tideprobe_step1/layer_sensitivity}"
...
EVICTION_RAW_DIR="${EVICTION_RAW_DIR:-/home/ma-user/work/bucket-wulan-green/chenyanbo/decodeatt/runs/tideprobe_step1/eviction_alignment_raw}"
...
env \
  ...
  bash /home/ma-user/work/bucket-wulan-green/chenyanbo/decodeatt/scripts/tideprobe/layer_sensitivity_8gpu.sh
...
env \
  ...
  bash /home/ma-user/work/bucket-wulan-green/chenyanbo/decodeatt/scripts/tideprobe/eviction_alignment_8gpu.sh
...
env \
  ...
  STRATEGIES="$EVICTION_STRATEGIES" \
  BUDGETS="$EVICTION_BUDGETS" \
  bash /home/ma-user/work/bucket-wulan-green/chenyanbo/decodeatt/scripts/tideprobe/sparse_cliff.sh
